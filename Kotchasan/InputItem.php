...
class InputItem
{
     ...
     * @assert create('1')->toArray() [throws] \Kotchasan\InputItemException
     *
     * @throws \Kotchasan\InputItemException ถ้า $value ไม่ใช่แอเรย์
     *
     * @return array
     */
    public function toArray()
    {
        if (is_array($this->value)) {
            ...
            throw new \Kotchasan\InputItemException('Not an array');
        }
    }
